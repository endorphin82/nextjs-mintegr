    ...
    <MainLayout>
      ...
      <div className="row">
        <div className="left-sidebar">
          ...
          {/*  <p><img className="alignnone size-full wp-image-2262"*/}
          ...
          {/*        <p className="custom-text-os"><a href="http://mintegr.loc/migration/">Migration</a> 1.x - 2.x</p>*/}
          {/*      </li>*/}
          {/*      <li><i className="fa-li fa fa-angle-right" aria-hidden="true"></i>*/}
          {/*        <p className="custom-text-os"><a href="http://mintegr.loc/creating-new-store-scratch/">Creating new*/}
          ...
          {/*          business</p>*/}
          {/*      </li>*/}
          {/*      <li><i className="fa-li fa fa-thumbs-o-up fa-lg" aria-hidden="true"></i>*/}
